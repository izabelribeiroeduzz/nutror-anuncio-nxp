        ...
        <section className="container section-y-lg">
          <OfferCarouselRow
            ...
            items={[
              {
                id: 'm1',
                title: 'Design Systems do zero ao avançado',
                subtitle: 'Guilherme Fraga',
                ownerAvatar: 'https://i.pravatar.cc/80?img=12',
                duration: '18h · 42 aulas',
                thumbImage: offerImg.designSystems,
                href: 'https://nutror.com/curso/design-systems',
                external: true,
              },
              {
                id: 'm2',
                title: 'Figma para Product Designers',
                subtitle: 'Rafael Mafra',
                ownerAvatar: 'https://i.pravatar.cc/80?img=68',
                duration: '12h · 28 aulas',
                thumbImage: offerImg.lessonFigma,
                href: 'https://nutror.com/curso/figma-pd',
                external: true,
              },
              {
                id: 'm3',
                title: 'Product Discovery Essentials',
                subtitle: 'Thalita Uba',
                ownerAvatar: 'https://i.pravatar.cc/80?img=47',
                duration: '8h · 19 aulas',
                thumbImage: offerImg.lessonAnalise,
                href: 'https://nutror.com/curso/product-discovery',
                external: true,
              },
              {
                id: 'm4',
                title: 'UX Writing para produto digital',
                subtitle: 'Marina Aguiar',
                ownerAvatar: 'https://i.pravatar.cc/80?img=45',
                duration: '6h · 14 aulas',
                thumbImage: offerImg.lessonEntrevista,
                href: 'https://nutror.com/curso/ux-writing',
                external: true,
              },
              {
                id: 'm5',
                title: 'Pesquisa Quantitativa em UX',
                subtitle: 'Natasha Jen',
                ownerAvatar: 'https://i.pravatar.cc/80?img=26',
                duration: '14h · 32 aulas',
                thumbImage: offerImg.workshopPesquisa,
                href: 'https://nutror.com/curso/pesquisa-quanti',
                external: true,
              },
              {
                id: 'm6',
                ...
                subtitle: 'Luiz Alt',
                ownerAvatar: 'https://i.pravatar.cc/80?img=15',
                duration: '10h · 24 aulas',
                thumbImage: offerImg.lessonPortfolio,
                href: 'https://nutror.com/curso/arquitetura-info',
                external: true,
              },
            ]}
          />
